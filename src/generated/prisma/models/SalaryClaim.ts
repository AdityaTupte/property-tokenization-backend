...
// @ts-nocheck 
/*
 * This file exports the `SalaryClaim` model and its related types.
 *
...
export type GetSalaryClaimAggregateType<T extends SalaryClaimAggregateArgs> = {
      [P in keyof T & keyof AggregateSalaryClaim]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSalaryClaim[P]>
    : Prisma.GetScalarType<T[P], AggregateSalaryClaim[P]>
}
...
export type GetSalaryClaimGroupByPayload<T extends SalaryClaimGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SalaryClaimGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SalaryClaimGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SalaryClaimGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SalaryClaimGroupByOutputType[P]>
      }
    >
  >
...
export type SalaryClaimCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SalaryClaimFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SalaryClaimDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SalaryClaim'], meta: { name: 'SalaryClaim' } }
  /**
   ...
   * })
  **/
  count<T extends SalaryClaimCountArgs>(
    args?: Prisma.Subset<T, SalaryClaimCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SalaryClaimCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SalaryClaimGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SalaryClaimGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSalaryClaimGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
