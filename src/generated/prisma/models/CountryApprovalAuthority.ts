...
// @ts-nocheck 
/*
 * This file exports the `CountryApprovalAuthority` model and its related types.
 *
...
export type GetCountryApprovalAuthorityAggregateType<T extends CountryApprovalAuthorityAggregateArgs> = {
      [P in keyof T & keyof AggregateCountryApprovalAuthority]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCountryApprovalAuthority[P]>
    : Prisma.GetScalarType<T[P], AggregateCountryApprovalAuthority[P]>
}
...
export type GetCountryApprovalAuthorityGroupByPayload<T extends CountryApprovalAuthorityGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CountryApprovalAuthorityGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CountryApprovalAuthorityGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CountryApprovalAuthorityGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CountryApprovalAuthorityGroupByOutputType[P]>
      }
    >
  >
...
export type CountryApprovalAuthorityOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "authority" | "threshold" | "created_time" | "last_modified", ExtArgs["result"]["countryApprovalAuthority"]>
...
export type CountryApprovalAuthorityCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CountryApprovalAuthorityFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CountryApprovalAuthorityDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CountryApprovalAuthority'], meta: { name: 'CountryApprovalAuthority' } }
  /**
   ...
   * })
  **/
  count<T extends CountryApprovalAuthorityCountArgs>(
    args?: Prisma.Subset<T, CountryApprovalAuthorityCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CountryApprovalAuthorityCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CountryApprovalAuthorityGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CountryApprovalAuthorityGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCountryApprovalAuthorityGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
