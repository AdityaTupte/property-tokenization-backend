...
// @ts-nocheck 
/*
 * This file exports the `ApproveStateAuthorityReceipt` model and its related types.
 *
...
export type GetApproveStateAuthorityReceiptAggregateType<T extends ApproveStateAuthorityReceiptAggregateArgs> = {
      [P in keyof T & keyof AggregateApproveStateAuthorityReceipt]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateApproveStateAuthorityReceipt[P]>
    : Prisma.GetScalarType<T[P], AggregateApproveStateAuthorityReceipt[P]>
}
...
export type GetApproveStateAuthorityReceiptGroupByPayload<T extends ApproveStateAuthorityReceiptGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ApproveStateAuthorityReceiptGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ApproveStateAuthorityReceiptGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ApproveStateAuthorityReceiptGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ApproveStateAuthorityReceiptGroupByOutputType[P]>
      }
    >
  >
...
export type ApproveStateAuthorityReceiptCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ApproveStateAuthorityReceiptFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ApproveStateAuthorityReceiptDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ApproveStateAuthorityReceipt'], meta: { name: 'ApproveStateAuthorityReceipt' } }
  /**
   ...
   * })
  **/
  count<T extends ApproveStateAuthorityReceiptCountArgs>(
    args?: Prisma.Subset<T, ApproveStateAuthorityReceiptCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ApproveStateAuthorityReceiptCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ApproveStateAuthorityReceiptGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ApproveStateAuthorityReceiptGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetApproveStateAuthorityReceiptGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
