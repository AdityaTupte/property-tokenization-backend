...
// @ts-nocheck 
/*
 * This file exports the `ApproveCountryAuthorityReceipt` model and its related types.
 *
...
export type GetApproveCountryAuthorityReceiptAggregateType<T extends ApproveCountryAuthorityReceiptAggregateArgs> = {
      [P in keyof T & keyof AggregateApproveCountryAuthorityReceipt]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateApproveCountryAuthorityReceipt[P]>
    : Prisma.GetScalarType<T[P], AggregateApproveCountryAuthorityReceipt[P]>
}
...
export type GetApproveCountryAuthorityReceiptGroupByPayload<T extends ApproveCountryAuthorityReceiptGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ApproveCountryAuthorityReceiptGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ApproveCountryAuthorityReceiptGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ApproveCountryAuthorityReceiptGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ApproveCountryAuthorityReceiptGroupByOutputType[P]>
      }
    >
  >
...
export type ApproveCountryAuthorityReceiptOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "proposal_key" | "approval_time" | "signer", ExtArgs["result"]["approveCountryAuthorityReceipt"]>
...
export type ApproveCountryAuthorityReceiptCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ApproveCountryAuthorityReceiptFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ApproveCountryAuthorityReceiptDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ApproveCountryAuthorityReceipt'], meta: { name: 'ApproveCountryAuthorityReceipt' } }
  /**
  ...
  **/
  count<T extends ApproveCountryAuthorityReceiptCountArgs>(
    args?: Prisma.Subset<T, ApproveCountryAuthorityReceiptCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ApproveCountryAuthorityReceiptCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ApproveCountryAuthorityReceiptGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ApproveCountryAuthorityReceiptGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetApproveCountryAuthorityReceiptGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
