...
export type adminWhereInput = {
    ...
    user?: Prisma.StringFilter<"admin"> | string;
};
...
export type adminScalarWhereWithAggregatesInput = {
    ...
    user?: Prisma.StringWithAggregatesFilter<"admin"> | string;
};
...
export type adminOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"user", ExtArgs["result"]["admin"]>;
...
export interface adminDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const adminWithUserOnly = await prisma.admin.findMany({ select: { user: true } })
     *
     */
     ...
     * })
     *
     * // Create many Admins and only return the `user`
     * const adminWithUserOnly = await prisma.admin.createManyAndReturn({
     *   select: { user: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     *
     * // Update zero or more Admins and only return the `user`
     * const adminWithUserOnly = await prisma.admin.updateManyAndReturn({
     *   select: { user: true },
     *   where: {
     *     // ... provide filter here
     *   },
...
export interface adminFieldRefs {
    readonly user: Prisma.FieldRef<"admin", 'String'>;
}
/**
 * admin findUnique
 */
